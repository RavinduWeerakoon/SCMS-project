...
INSERT INTO `assistant_roster` VALUES (21,'2023-10-02','2023-10-22',0,40.00),(21,'2023-11-02','2023-11-30',3,50.00),(22,'2023-11-02','2023-11-30',0,37.00),(23,'2023-11-02','2023-11-30',0,35.00),(25,'2023-10-02','2023-10-27',0,39.00),(25,'2023-11-02','2023-11-30',0,30.00);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `assistant_roster_BEFORE_INSERT` BEFORE INSERT ON `assistant_roster` FOR EACH ROW BEGIN
IF  NEW.end_date<=current_date() then
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'The end date must be grater than the curent date';
    END IF;
...
INSERT INTO `driver_roster` VALUES (54,'2023-10-23','2023-11-20',0,8.00),(55,'2023-10-23','2023-11-20',0,24.00),(56,'2023-10-23','2023-11-20',1,34.00),(60,'2023-10-16','2023-10-22',0,30.00),(60,'2023-10-23','2023-10-30',1,25.00);
...
CREATE TABLE `product` (
  ...
  PRIMARY KEY (`ID`),
  KEY `product_index` (`ID`,`name`,`type`,`description`,`unit_capacity`,`unit_price`)
...
INSERT INTO `train_bulk` VALUES (11,1,'Colombo',1,'1',3.00,1,1),(12,1,'Colombo',1,'1',3.00,1,1),(13,1,'Colombo',1,'1',3.00,NULL,1),(14,1,'Colombo',1,'2',3.00,NULL,1),(16,7,'Colombo',1,'4',7.00,NULL,NULL),(17,7,'Jaffna',3,'6',13.00,NULL,NULL),(18,7,'Jaffna',3,'6',13.00,NULL,NULL),(19,7,'Colombo',1,'4',14.00,NULL,NULL),(20,9,'Jaffna',1,'3',7.00,NULL,NULL),(21,9,'Galle',1,'4',10.00,NULL,NULL),(22,7,'Gampaha',1,'3',17.00,NULL,NULL),(23,7,'Gampaha',6,'5',28.00,NULL,NULL),(24,8,'Kurunagala',6,'5',42.00,NULL,NULL),(25,8,'Gampaha',3,'6',30.00,NULL,NULL),(26,10,'Matara',3,'6',20.00,NULL,NULL),(27,9,'Colombo',3,'6',20.00,NULL,NULL),(28,7,'Ragama',3,'6',8.00,NULL,NULL);
...
INSERT INTO `train_schedule` VALUES (1,'2023-10-13',6000.34,1,'00:00:12'),(2,'2023-10-12',6000.87,1,'12:00:00'),(3,'2023-10-12',6000.87,1,'12:00:00'),(4,'2023-10-26',6001.00,1,'12:00:00'),(5,'2023-11-02',420.00,6,'02:40:00'),(6,'2023-11-04',80.00,3,'17:44:00'),(7,'2023-11-22',300.00,2,'23:59:00'),(8,'2023-11-07',300.00,2,'13:03:00');
...
INSERT INTO `truck_schedule` VALUES (2,'10001',21,55,'12:30:00','2023-10-30',1,13),(4,'10001',21,55,'12:30:00','2023-10-31',1,13),(5,'10002',22,54,'16:24:00','2023-10-29',1,11),(7,'10003',21,54,'14:28:00','2023-11-10',1,13),(8,'10002',22,56,'02:10:00','2023-11-16',1,11),(9,'30001',21,55,'02:15:00','2023-11-24',1,11),(10,'10003',22,54,'18:24:00','2023-11-14',1,12),(11,'10002',21,56,'06:21:00','2023-11-20',1,13),(12,'10002',21,56,'06:21:00','2023-11-20',1,13),(13,'10002',21,56,'06:21:00','2023-11-20',1,13);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `user_BEFORE_INSERT` BEFORE INSERT ON `user` FOR EACH ROW BEGIN
    ...
    IF LENGTH(NEW.phone) != 10 THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'The contact number must be 10 digits long';
    END IF;
...
BEGIN
  ...
  insert into `train_bulk` (`order`, `destination`, `train`, `schedule_id`, `sending_quantity`) VALUES (order_id, detination, train, train_schedule_id,qty);
   ...
   select distinct p.unit_capacity into unit_cap
   from orders o join product p 
   on (o.product_id=p.ID) where o.ID=order_id;
   
   update train_schedule ts
   set ts.available_capacity = ts.available_capacity-qty * unit_cap
   where ts.schedule_id = train_schedule_id;
...
BEGIN
    ...
    where a_r.user_id = driver_assistant and a_r.end_date > current_date();
...
-- Dump completed on 2024-07-15 19:15:12
